...
const PropertyPartsPage: FC = () => {
    ...
    const [filteredPropertyParts, setFilteredPropertyParts] = useState<Unit[]>([]);
    ...
    const fetchPropertyParts = async () => {
        try {
            ...
            // Attach property name to each part
                        ...
                        <div className='border border-gray-300 rounded-md p-1'>
                            <div className='flex justify-center space-x-1'>
                                ...
                                >
                                    ...
                                    <option value="location">Amount</option>
                            ...
                            <tbody>
                                {loading ? (
                                    ...
                                    <tr className="text-center text-gray-500">
                                        <td colSpan={5} className='py-4'>No Property Parts Found...</td></tr>
                                ) :
                                    (currentItems.map((unit, index) => (
                                        <tr key={unit.id} className="border-b border-slate-100 hover:bg-gray-50">
                                            ...
                                            <td className="px-3 text-slate-600 font-normal cursor-pointer">
                                                <span className={`${statusColors[unit.status]} px-3 py-1 text-sm rounded-full`}
                                                    onClick={() => openStatusModal(unit.id)}>{unit.status}</span>
                                            </td>
                                            <td className="p-3 ">
